...
ggsave("plot2.png", width = 13.5, height = 17.5, units = "cm")
...
ggsave("plot3.png", width = 13.5, height = 17.5, units = "cm")
...
ggsave("plot4.png", width = 13.5, height = 17.5, units = "cm")
...
ggsave("plot5.png", width = 13.5, height = 17.5, units = "cm")
...
ggsave("plot6.png", width = 13.5, height = 17.5, units = "cm")
